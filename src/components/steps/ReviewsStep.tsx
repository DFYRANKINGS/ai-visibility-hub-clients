...
export function ReviewsStep({ reviews, onChange }: ReviewsStepProps) {
  ...
  return (
    <FormCard 
      ...
      description="Add testimonials and reviews from your customers."
    >
            ...
            >
              <div className="flex items-center gap-3">
                <span className="font-medium text-foreground">
                  {review.customer_name || `Review ${index + 1}`}
                </span>
              ...
              <div className="p-4 pt-0 space-y-4 border-t border-border">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField label="Profession">
                    <Input
                      ...
                      onChange={(e) => updateReview(index, 'reviewer_profession', e.target.value)}
                    />
                  </FormField>
                  ...
                  <FormField label="Review Title">
                    <Input
                      ...
                      onChange={(e) => updateReview(index, 'review_title', e.target.value)}
                    />
                  </FormField>
                ...
                <FormField label="Review" required>
                  <Textarea
                    ...
                    onChange={(e) => updateReview(index, 'review_body', e.target.value)}
                    className="h-24"
                  />
                </FormField>
