...
const sheetMappers: SheetMapper<any>[] = [
  {
    ...
    rowMapper: (row) => ({
      ...
      price_range: row['Price'] || row['Price Range'] || '',
  ...
  },
  {
    ...
    rowMapper: (row) => ({
      ...
      address_street: row['Street'] || row['Address Street'] || '',
      address_city: row['City'] || row['Address City'] || '',
      address_state: row['State'] || row['Address State'] || '',
      address_postal_code: row['Postal Code'] || row['Zip'] || '',
      phone: row['Phone'] || '',
      hours: row['Hours'] || '',
    }),
  },
